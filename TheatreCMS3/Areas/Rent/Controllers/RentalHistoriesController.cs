...
namespace TheatreCMS3.Areas.Rent.Controllers
{
    public class RentalHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RentalHistoryId,RentalDamage,DamageIncurred,Rental")] RentalHistory rentalHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RentalHistoryId,RentalDamage,DamageIncurred,Rental")] RentalHistory rentalHistory)
        {
            if (ModelState.IsValid)
            {
