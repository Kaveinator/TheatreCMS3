...
namespace TheatreCMS3.Areas.Rent.Controllers
{
    public class RentalHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,RentalDamaged,DamageIncurred,Rental")] RentalHistory rentalHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,RentalDamaged,DamageIncurred,Rental")] RentalHistory rentalHistory)
        {
            if (ModelState.IsValid)
            {
