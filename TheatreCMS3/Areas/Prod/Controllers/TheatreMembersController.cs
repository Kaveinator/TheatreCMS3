...
namespace TheatreCMS3.Areas.Prod.Controllers
{
    public class TheatreMembersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TheatreMemberId,Name,YearJoined,MainRole,CurrentMember,Character,CastYearLeft,DebutYearLeft")] TheatreMember theatreMember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TheatreMemberId,Name,YearJoined,MainRole,CurrentMember,Character,CastYearLeft,DebutYearLeft")] TheatreMember theatreMember)
        {
            if (ModelState.IsValid)
            {
