...
namespace TheatreCMS3.Areas.Prod.Controllers
{
    public class CalendarEventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventId,StartDate,EndDate,StartTime,EndTime,TicketsAvailable,IsProduction,AllDay")] CalendarEvents calendarEvents)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventId,StartDate,EndDate,StartTime,EndTime,TicketsAvailable,IsProduction,AllDay")] CalendarEvents calendarEvents)
        {
            if (ModelState.IsValid)
            {
