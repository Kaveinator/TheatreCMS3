...
namespace TheatreCMS3.Areas.Prod.Controllers
{
    public class EventCalendarsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventId,Title,StartDate,EndDate,StartTime,EndTime,Allday,TicketsAvailable,isProduction")] EventCalendar eventCalendar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventId,Title,StartDate,EndDate,StartTime,EndTime,Allday,TicketsAvailable,isProduction")] EventCalendar eventCalendar)
        {
            if (ModelState.IsValid)
            {
