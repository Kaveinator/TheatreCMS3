...
namespace TheatreCMS3.Areas.Prod.Controllers
{
    public class CalenderEventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EventId,Title,StartDate,EndDate,StartTime,EndTime,Allday,TicketsAvailable,isProduction")] CalenderEvent calenderEvent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EventId,Title,StartDate,EndDate,StartTime,EndTime,Allday,TicketsAvailable,isProduction")] CalenderEvent calenderEvent)
        {
            if (ModelState.IsValid)
            {
