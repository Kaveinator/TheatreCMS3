...
/* After the model is created, scaffold the CRUD pages for this model 
 * (Use Visual Studio and EntityFramework to create the Index, Edit, Create, Details, and Delete pages).*/
